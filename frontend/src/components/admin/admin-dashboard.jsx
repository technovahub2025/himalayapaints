...
export function AdminDashboard({ initialItems, initialTableName, tableNames, email, initialSection = "dashboard" }) {
    ...
    const salesTrendSeries = useMemo(() => buildTrendSeries(filteredSales, (sale) => sale.createdAt, (sale) => sale.amount), [filteredSales]);
        ...
        <div className="space-y-6 sm:space-y-7">
            ...
            <div className="grid gap-6 xl:grid-cols-12">
                ...
                <ChartFrame title="Sales Trend" subtitle="Sales amount over time from the records fetched from the Sales API." badge={`${salesTrendSeries.length.toLocaleString()} point(s)`} icon={WalletCards} className="xl:col-span-7">
                    <TrendChart series={salesTrendSeries} colorClass="stroke-fuchsia-500" emptyLabel="No sales records are available for the current filters." />
                </ChartFrame>
                ...
                <ChartFrame title="Sales by Product" subtitle="Top products ranked by total sales amount." badge="Top 6" icon={Package2} className="xl:col-span-5">
                    <HorizontalBarChart data={salesByProductSeries} emptyLabel="No sales data is available for the current filters." valueLabel="amount" />
                </ChartFrame>
            </div>
            </> : null}
